...
const Detailed = () => {
  return (
    <section className="bg_dark_blue py-lg-5 position-relative h_100">
      <img
        src={detailed}
        alt="detailed"
        className="w-50 position-absolute start-0 d-none d-xl-block Detail"
        data-aos="fade-right"
      ...
      <div className="container py-5 mb-lg-5">
        <Row className="flex-lg-row align-items-center">
          ...
          <Col
            lg={5}
            xs={12}
            className="ps-lg-5 pt-3 pt-lg-0 text-center text-lg-start d-flex flex-column align-items-center align-items-lg-start"
            data-aos="fade-left"
